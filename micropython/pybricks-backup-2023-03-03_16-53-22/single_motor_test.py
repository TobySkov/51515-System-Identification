...
time_between_steps = 1000    # Target time between steps [ms]
time_between_logs = 1     # Target time between loggings
logs_between_steps = int(time_between_steps/time_between_logs)

# Program 1:
duties = [0, 20, 40, 60, 80, 100]
# Program 2:
...
# Allocate memory:
mem_hub_battery_voltage = [0.0]*len_duty 
mem_hub_battery_current = [0.0]*len_duty
mem_motor_speed = [0.0]*len_duty
mem_motor_load = [0.0]*len_duty
mem_time = [0.0]*len_duty
